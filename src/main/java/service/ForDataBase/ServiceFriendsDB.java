...
{
    Repository<Integer, User> users_repo;
    Repository<Integer, Prietenie> prietenii_repo;
     ...
     */
    public ServiceFriendsDB(Repository<Integer, User> users_repo, Repository<Integer, Prietenie> prietenii_repo)
    {
    ...
    public Prietenie delete_prietenie(int id) throws EntityIsNull, EntityNotFound, SQLException {
